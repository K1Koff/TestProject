...
`class` - це новий простіший спосіб опису функцій-конструкторів, які ти вже проходив. Познайомишся трохи пізніше, зараз це неважливо. \
...
чистішим, ізольованим і немає каші, яка була б тоді, коли ти написав в одному файлі все. Теж пізніше познайомишся теж.
