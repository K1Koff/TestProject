...
export class DataGeneratorService {
    ...
    generateName() {
        ...
        // являє собою масив рядків, які є рандомними іменами. Метод має повертати рандомне ім'я з цього масиву.
    ...
    generateLastName() {
        ...
        // являє собою масив рядків, які є рандомними прізвищами. Метод має повертати рандомне прізвище з цього масиву.
